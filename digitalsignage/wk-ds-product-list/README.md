...
https://wk-ds-product-list.firebaseapp.com/
...
git clone https://github.com/PolymerLabs/wk-ds-product-list
cd wk-ds-product-list
npm install
polymer serve
```
...
<meta name="description" content="wk-ds-product-list">
<meta name="theme-color" content="#ffffff">
<title>wk-ds-product-list</title>
```
...
```json
"description": "wk-ds-product-list",
"start_url": "index.html",
"name": "wk-ds-product-list",
...
Let me know of any [issues](https://github.com/PolymerLabs/wk-ds-product-list/issues).
...
```
Could not resolve module specifier "require" in file "..src/wk-ds-product-list.js".
```
