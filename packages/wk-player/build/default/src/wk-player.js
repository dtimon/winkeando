define(["exports"], function (_exports) {
  ...
  */
  ...
  function (_LitElement) {
    babelHelpers.inherits(WkPlayer, _LitElement);

    function WkPlayer() {
      babelHelpers.classCallCheck(this, WkPlayer);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(WkPlayer).apply(this, arguments));
    }

    babelHelpers.createClass(WkPlayer, [{
      key: "render",
       ...
       */
      value: function render() {
        return html(_templateObject_5cb12bd0392c11e995e1ab62425323f8());
      }
    }, {
      key: "_startElement",
      value: function _startElement(el) {
      ...
      key: "_stopElement",
      value: function _stopElement(el) {
      ...
      key: "_getPlayerAttributes",
      value: function _getPlayerAttributes(elPlaying) {
        var timer = elPlaying.getAttribute('data-wk-player');
        timer = babelHelpers.typeof(timer) === 'object' ? timer : JSON.parse(String(timer));
        return timer;
      }
    }, {
      key: "_renderElement",
      value: function _renderElement(elPlaying, options) {
        var _this13 = this;

        this._startElement(elPlaying);

        setTimeout(function () {
          _this13._stopElement(elPlaying);

          _this13.playing = (_this13.playing + 1) % _this13.elements.length;
          elPlaying = _this13.elements[_this13.playing];

          var options = _this13._getPlayerAttributes(elPlaying);

          _this13._renderElement(elPlaying, options);
        }, options.timer * 1000);
      }
    }, {
      key: "update",
      value: function update() {
        babelHelpers.get(babelHelpers.getPrototypeOf(WkPlayer.prototype), "update", this).call(this);
        /**
        ...
        this.playing = 0;
        var elPlaying = this.elements[this.playing];

        var options = this._getPlayerAttributes(elPlaying);
